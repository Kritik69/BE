    ...
    <>
      ...
      >
        ...
        <form className="contact-form" ref={form} onSubmit={sendEmail}>
          ...
          <input className="form-inputs" type="text" name="user_name" />
          <label className="form-labels">Email</label>
          <input className="form-inputs" type="email" name="user_email" />
          <label className="form-labels">Message</label>
          <textarea  className="form-txt-area" name="message" />
          <input className="from-submit-btn" type="submit" value="Send" />
        </form>
        ...
        >
          ...
          <strong>
            Address: <span>Mahavir Education Trust Chowk,
W.T Patil Marg, D P Rd, next to Duke's Company,
Chembur, Mumbai, Maharashtra 400088</span>
          </strong>
        </div>
        <p style={{
            padding:"10px 0",
