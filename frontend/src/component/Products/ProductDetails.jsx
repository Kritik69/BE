          ...
          <div className="ProductDetails">
            ...
            <div className="varse__2">
              ...
              <div className="detailsBlock">
                ...
                <div><h3>Material: {product.material}</h3></div>
                <div><h3>Strength: {product.durability}</h3></div>
                <div><h3>Length: {product.length} cm</h3></div>
                <div><h3>Width: {product.width} cm</h3></div>
                <div><h3>Height: {product.height} cm</h3></div>
                <div><h3>Weight: {product.weight} kgs</h3></div>
                <div><h3>Tensile: {product.tensile} MPa</h3></div>
                <div
