...
import logo from './Assets/logo try 1.png'
    ...
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        ...
        <div className="location flex py__10">
          ...
          <h6>Mahavir Education Trust Chowk, <br/>W.T Patil Marg, D P Rd, next to Duke's Company, <br/>Chembur, Mumbai, Maharashtra 400088</h6>
        </div>
        ...
        <div className="location flex py__10">
          ...
          <strong>Email:</strong>
          <h6>kritikjambusariya@gmail.com</h6>
        </div>
